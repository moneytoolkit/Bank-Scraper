...
class RbsScraper(Scraper):
    ...
    def __scrape_accountlist(self, allofit, page):
        ...
        return self._parseRBSLinks(page)
    ...
    def _parseRBSLinks(self, raw):
        ...
        if len(rightButtons) == 0:
            logging.error('RBS no accountbuttons - odd - html changed??')
            return 'bank error'
    ...
    def prepParse(self, allofit, facade, token):
        ...
        # lower case them incase any auto casing in the app - RBS is case insensitive.
        ...
        for creds in self.filledCreds:
            try: 
                ...
                logging.warning('RBS utf8 encoding error - ' + str(e))
    ...
    def gettheAccounts(self, facade, accountList, token, step, allofit, page):    
        ...
        if step == 1:
            ...
            # make sure we move on one - if step 5 then later we set END
            self.response['step'] = 5
    ...
    def getxactlist(self, facade, accountList, token, step, allofit):    
        ...
        if step == 4 or step ==5:
            ...
            if scrape_result == "got list":
                ...
                for ac in self.accountLinks:
                    ...
                    # simple lookup here as login sets up mayAccounts in RBS
        ...
        if step == 6:
            ...
            scrape_result = self.doStep6(page)
