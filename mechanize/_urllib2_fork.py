...
class OpenerDirector:
    def __init__(self):
        ...
        # DANX  - MODIFICATION cos dont know how to specify an Opener Director
        client_version = "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_7; en-us) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/533.20.27"
        # END DANX
